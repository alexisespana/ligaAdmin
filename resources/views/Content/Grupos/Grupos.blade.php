                        ...
                        <ul class="list-group list-group-flush list-group-numbered">
                            @if (is_array($item->grupos))
                                <div class="row">
                                            ...
                                            <div class="card border h-100 border-primary">
                                                <div class="card-body">
                                                    ...
                                                    @forelse ($item->equipos as $equipo)
                                                        @if ($equipo->grupo->grupo_id == $grupo->id)
                                                        ...
                                                        @else
                                                            {{-- <li class="list-group-item">NO SE HA ASIGNADO EQUIPOS PARA ESTE GRUPO</li> --}}
                                                        @endif
                                    ...
                                    @empty
                                        <li>LOS EQUIPOS DE LA CATEGORIA {{ $item->nombre }} NO TIENEN GRUPOS</li>
                                    @endforelse
